...
import rospy
from psaf_messages.msg import TrafficSignInfo, SpeedSign, StopMark, TrafficLight, StopLineInfo, StopLine
...
from psaf_perception.StopLineDetector import StopLineDetector
...
class DetectionService:
    ...
    def __on_new_stop_lines(self, detected: List[DetectedObject]):
